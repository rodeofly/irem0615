...
$ ->
  ...
  $.get "img/carte2.svg", (rawSvg) -> 
    ...
    $( "#crocodile").on "click", -> open_new_tab("AlligatorEggs/index.html")
    $( "#poisson1").on "click", -> open_new_tab("Carroll/tag3.html")
    $( "#poisson2").on "click", -> open_new_tab("Carroll/tag3.html")
    $( "#tribunal").on "click", -> open_new_tab("Carroll/LogicGame1.html")
